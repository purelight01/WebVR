...
class Action extends Game {
    ...
    */
    public createActions(): void {
        ...
        // Set the box
        //
        this._box.actionManager = new BABYLON.ActionManager(this.getScene());
        ...
        // Set the plane
        //
        this._plane.actionManager = new BABYLON.ActionManager(this.getScene());
...
export function run(): void {
    let action = new Action(Common.canvasName, true);
    action.createScene();
